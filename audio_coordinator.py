...
class AudioCoordinator:
    ...
    def _update_audio_sources(self, objects):
        ...
        for obj in objects:
            ...
            volume = min(1.0, max(0.1, size_ratio * 3))  # Multiply by 3 to boost smaller objects
            ...
            if obj_id not in self.active_audio_objects:
                ...
                print(f"  🎵 Audio source added: {obj.label} (ID: {obj_id}) - {signature_name} sound")
    ...
    def _get_signature_name(self, label):
        ...
        if "person" in label_lower or "human" in label_lower:
            ...
            return "cup"
        elif "obstacle" in label_lower or "wall" in label_lower or "furniture" in label_lower:
            return "obstacle"
        else:
            return "default"
